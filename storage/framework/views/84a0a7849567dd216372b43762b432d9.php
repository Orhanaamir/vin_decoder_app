...
<div class="header">
  ...
  <div class="container1"  >
    ...
    <?php elseif($dayremaining > 0): ?>
        ...
        <?php else: ?>
        <a href="/">
        <button type="button" style="margin-top: 10px;" class="btn btn-dark btn-block px-0" >Reports Left: <?php echo e($remrep); ?></button>
        </a>
        <?php endif; ?>
        ...
        <div class="card-box mb-30" style="padding: 20px;">
          ...
          <div class="pb-20">
            <h3style=" margin-bottom:30px;">Your Reports</h3>
                ...
                <tr>
                  <td class="table-plus"><?php echo e(Auth::user()->name); ?></td>
									
									<td><?php echo e($report->vin); ?></td>
									<td><?php echo e($report->created_at->format('d/m/Y')); ?></td>
									<td>
                    <div class="dropdown">
                      
                        <a class=" clickable-link" data-toggle="modal"
                        data-target="#historyreport" id="historyreportbtn" data-id="<?php echo e($report->id); ?>"><i class="dw dw-eye"></i> View Report</a>
											</div>
										</div>
									</td>
								</tr>
...
</html><?php /**PATH /home/maxallowance/public_html/homeb.maxallowance.com/resources/views/report.blade.php ENDPATH**/ ?>