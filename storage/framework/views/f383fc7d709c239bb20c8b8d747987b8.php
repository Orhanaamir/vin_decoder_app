    ...
    <div class="top_bar_left clearfix">
      <div class="logo-login">
        <a id="logo-login" href="/" style="display: inline;" title="BeLanding 4 - Betheme" data-height="60" data-padding="15">
          <img class="logo-login-main scale-with-grid svg" src=<?php echo e(url('img/logo.png')); ?> data-retina="" data-height="" alt="landing4" width="190" data-no-retina />
        </a>
      </div>
...
<?php /**PATH /home/maxallowance/public_html/homeb.maxallowance.com/resources/views/login.blade.php ENDPATH**/ ?>