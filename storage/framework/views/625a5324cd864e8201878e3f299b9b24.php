...
<head>
	...
	<link rel='stylesheet' href=<?php echo e(url('css/structure.css')); ?>>
	<link rel='stylesheet' href=<?php echo e(url('css/landing4.css')); ?>>
	<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
	<link rel="stylesheet" href=<?php echo e(url('css/rs6.css')); ?>>
	<style>
								...
								<div class="logo">
									<a id="logo" href="/" style="display: inline;" title="BeLanding 4 - Betheme"
										data-height="60" data-padding="15"><img class="logo-main scale-with-grid svg"
											src=<?php echo e(url('img/maxlogo3.png')); ?> data-retina="" data-height="" alt="landing4"
											...
											class="logo-mobile-sticky scale-with-grid svg" src=<?php echo e(url('img/maxlogo3.png')); ?>
						...
						<rs-module id="rev_slider_1_1" data-version="6.5.11">
							<rs-slides>
								<rs-slide style="position: absolute;" data-key="rs-1" data-title="Slide" data-in="o:0;"
									data-out="a:false;"> <img src=<?php echo e(url('img/dummy.png')); ?> alt="Slide" title="Home"
										class="rev-slidebg tp-rs-img rs-lazyload"
										data-lazyload=<?php echo e(url('img/transparent.png')); ?> data-parallax="off">
									<!--
										-->
									<rs-group id="slider-1-slide-1-layer-4" data-type="group" data-rsp_ch="on"
										...
										<rs-layer id="slider-1-slide-1-layer-3" data-type="image" data-rsp_ch="on"
											...
											data-frame_999="o:0;st:w;" style="z-index:11;"><img
												src=<?php echo e(url('img/dummy.png')); ?> class="tp-rs-img rs-lazyload" width="30"
												height="30" data-lazyload=<?php echo e(url('img/landing4-slider-icon1.webp')); ?>>
										</rs-layer>
										<!--
											-->
									</rs-group>
									...
									<rs-layer id="slider-1-slide-1-layer-1" data-type="shape" data-rsp_ch="on"
										...
										<rs-bg-elem style="background: url(" <?php echo e(url('img/landing4-slider-bg.webp')); ?>")
									...
									<rs-layer id="slider-1-slide-1-layer-6" class="rs-pxl-2" data-type="image"
										...
										data-frame_999="o:0;st:w;" style="z-index:22;"><img src=<?php echo e(url('img/dummy.png')); ?>

											class="tp-rs-img rs-lazyload" width="33" height="33"
											data-lazyload=<?php echo e(url('img/landing4-slider-bg.webp')); ?>>
									</rs-layer>
									<!--
									...
									<rs-layer id="slider-1-slide-1-layer-17" class="rs-pxl-15" data-type="image"
										...
										data-frame_0="y:-50,-50,-31,-31;" data-frame_1="st:500;sp:500;"
										data-frame_999="o:0;st:w;" style="z-index:20;"><img src=<?php echo e(url('img/dummy.png')); ?>

											class="tp-rs-img rs-lazyload" width="675" height="575"
											data-lazyload=<?php echo e(url("img/LandingPage.png")); ?>>
									</rs-layer>
									<!--
									...
									<rs-layer id="slider-1-slide-1-layer-18" class="rs-pxl-4" data-type="image"
										...
										style="z-index:24;"><img src=<?php echo e(url('img/dummy.png')); ?>
									...
									<rs-layer id="slider-1-slide-1-layer-19" class="rs-pxl-5" data-type="image"
										...
										data-frame_1="st:500;sp:500;" data-frame_999="o:0;st:w;"
										style="z-index:23;"><img src=<?php echo e(url('img/dummy.png')); ?>
									...
									<rs-layer id="slider-1-slide-1-layer-20" class="rs-pxl-14" data-type="image"
										...
										style="z-index:21;"><img src=<?php echo e(url('img/dummy.png')); ?>

											class="tp-rs-img rs-lazyload" width="1363" height="869"
											data-lazyload=<?php echo e(url('img/landing4-slider-pic1.webp')); ?>>
									</rs-layer>
									<!--
								...
								<div class="text-center"
									...
									<div class="google_font"
										...
										<sup style="font-size: 0.6em;">$</sup><span
											class="counter-inline animate-math"><?php echo e($plan->price); ?></span></span><span
											style="font-size: 0.5em"><?php if($plan->day_for_plan > 29): ?>
									...
									<hr class="no_line" style="margin: 0 auto 15px auto" />
									<p class="big"> Days For Plan: <?php echo e($plan->day_for_plan); ?></p>
									<hr class="no_line" style="margin: 0 auto 15px auto" />
									<p> <b><span class="counter-inline animate-math"> Number Of Reports: <span
													class="number"
													data-to="<?php echo e($plan->reports); ?>">
									    
									    
									        <?php echo e($plan->reports); ?>
									...
									<p> <b>
									        ...
									        PLUS <?php echo e($plan->free_report); ?> FREE REPORT<?php echo e($plan->free_report > 1 ? 'S' : ''); ?>

									    
									    
									    </b>  </p>
									<p> <?php echo e($plan->free_report > 1 ? 'Use your FREE reports to check the history of additional vehicles you own or cars you might wanna buy.' : 'Use your FREE report  to check the history of a 2nd vehicle you own or a car you might want to buy'); ?>  </p>
									<hr class="no_line" style="margin: 0 auto 60px auto" />
									<?php if(Auth::check()): ?>
									
									<!-- User is logged in -->
									<a href="/plancheckout/<?php echo e($plan->plan_id); ?>"
				...
				<div class="col-md-12" data-col="two-third">
					<div class="image_frame image_item no_link scale-with-grid text-center no_border">
						<div class="image_wrapper"><img class="scale-with-grid"
								src=<?php echo e(url("img/landing4-pic18.webp")); ?> /> </div>
					</div>
					<div class="text-center">
	...
	<div id="Content">
			...
			<div class="row">
				...
				<div class="col-md-2" data-col="one-sixth">
					...
					<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
						<div class="image_wrapper"><img class="scale-with-grid" src=<?php echo e(url("img/landing4-pic1.webp")); ?> />
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6" data-col="one-second">
					<div class="image_frame image_item no_link scale-with-grid no_border">
						<div class="image_wrapper"><img class="scale-with-grid"
								src=<?php echo e(url("img/LandingPageblue.png")); ?> /> </div>
					</div>
				</div>
					...
					<div class="image_frame image_item scale-with-grid text-center no_border">
						<div class="image_wrapper">
							<a href="https://www.youtube.com/watch?v=1ZmmlMFj74k" rel="prettyphoto">
								<div class="mask"></div><img src=<?php echo e(url("img/landing4-pic3.webp")); ?> />
							</a>
		...
		<div class="section mcb-section no-margin-h full-width" style="padding-bottom:120px;background-color:#0b1556">
			<div class="row">
				...
				<!--					src="<?php echo e(url('img/landing4-pic6.webp')); ?>"-->
				<!--					class="scale-with-grid wp-post-image" /> </li>-->
				<!--			<li class="content_slider_li_2"><img width="1024" height="700"-->
				<!--					src=<?php echo e(url("img/landing4-pic5.webp")); ?> class="scale-with-grid wp-post-image"-->
				<!--					loading="lazy" /> </li>-->
				<!--			<li class="content_slider_li_3"><img width="1024" height="700"-->
				<!--					src=<?php echo e(url("img/landing4-pic4.webp")); ?> class="scale-with-grid wp-post-image"-->
				<!--					loading="lazy" /> </li>-->
				<!--		</ul>-->
		...
		<div class="section container" style="padding-top:120px;padding-bottom:50px">
			<div class="row">
				<div class="col-md-5" data-col="two-fifth">
					<div class="image_frame image_item no_link scale-with-grid no_border">
						<div class="image_wrapper"><img class="scale-with-grid" src=<?php echo e(url("img/landing4-pic7.webp")); ?> />
						</div>
					</div>
				</div>
		...
		<div class="section container">
			<div class="row">
				...
				<div class="col-md-5" data-col="two-fifth">
					<div class="image_frame image_item no_link scale-with-grid no_border">
						<div class="image_wrapper"><img class="scale-with-grid" src=<?php echo e(url("img/landing4-pic8.webp")); ?> />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="section mcb-section" style="padding-top:120px;padding-bottom:60px">
			<div class="container">
				...
				<div class="row" data-col="one">
					<div class="col-md-4 column_icon_box">
						<div class="icon_box icon_position_left no_border">
							<div class="image_wrapper"><img src=<?php echo e(url("img/landing4-icon1.webp")); ?>
					...
					<div class="col-md-4 column_icon_box">
						<div class="icon_box icon_position_left no_border">
							<div class="image_wrapper"><img src=<?php echo e(url("img/landing4-icon2.webp")); ?>
					...
					<div class="col-md-4 column_icon_box">
						<div class="icon_box icon_position_left no_border">
							<div class="image_wrapper"><img src=<?php echo e(url("img/landing4-icon3.webp")); ?>
				...
				<div class="row" data-col="one">
					<div class="col-md-4 column_icon_box">
						<div class="icon_box icon_position_left no_border">
							<div class="image_wrapper"><img src=<?php echo e(url("img/landing4-icon4.webp")); ?>
					...
					<div class="col-md-4 column_icon_box">
						<div class="icon_box icon_position_left no_border">
							<div class="image_wrapper"><img src=<?php echo e(url("img/landing4-icon5.webp")); ?>
					...
					<!--<div class="col-md-4 column_icon_box">-->
					<!--	<div class="icon_box icon_position_left no_border">-->
					<!--		<div class="image_wrapper"><img src=<?php echo e(url("img/landing4-icon6.webp")); ?>-->
					<!--				class="scale-with-grid" /> </div>-->
					<!--		<div class="desc_wrapper">-->
				...
				<div class="row" data-col="one"
					...
					<div class="col-md-2">
						<div class="image_frame image_item no_link scale-with-grid aligncenter no_border"
							...
							<div class="image_wrapper"><img class="scale-with-grid"
									src=<?php echo e(url("img/landing4-pic9.webp")); ?> /> </div>
						</div>
					</div>
					<div class="col-12">
					...
					<div class="col-md-2" style="display: flex;">
						<div class="image_frame image_item no_link scale-with-grid aligncenter no_border"
							...
							<div class="image_wrapper"><img class="scale-with-grid"
									src=<?php echo e(url("img/landing4-pic10.webp")); ?> /> </div>
						</div>
					</div>
					<!--<div class="col-md-4">-->
						...
						<div class="col-12">
							<div class="column_attr clearfix align_center"
								...
								<div class="image_frame image_item no_link scale-with-grid alignnone no_border"
									...
									<div class="image_wrapper"><img class="scale-with-grid"
											src=<?php echo e(url("img/landing4-pic11.webp")); ?> /> </div>
								</div>
								<hr class="no_line" style="margin: 0 auto 40px auto" />
								...
								<hr class="no_line" style="margin: 0 auto 30px auto" /> <img class="scale-with-grid"
									src=<?php echo e(url("img/profile3.jpg")); ?> style="
    width: 120px;
" />
...
" />
			...
			<div class="row" data-col="one"
				...
				<div class="col-md-5">
					<div class="image_frame image_item no_link scale-with-grid no_border" style="margin-top:-260px;">
						<div class="image_wrapper"><img class="scale-with-grid"
								src=<?php echo e(url("img/landing4-pic16.webp")); ?> /> </div>
					</div>
				</div>
				<div class="col-12">
				...
				<div class="col-12 column_clients">
					<ul class="clients clearfix ">
						<li style="width:25%">
							<div class="client_wrapper">
								<a target="_blank" href="#" title="C1">
									<div class="gs-wrapper"><img width="150" height="39" src=<?php echo e(url("img/ebait.png")); ?>
							...
							<div class="client_wrapper">
								<a target="_blank" href="#" title="C2">
									<div class="gs-wrapper"><img width="250" height="40"
											src=<?php echo e(url("img/idU11CHU_F.png")); ?> loading="lazy" />
									</div>
								</a>
							</div>
						</li>
						...
						<!--					src=<?php echo e(url("img/chrome-data-solutions_owler_20170705_164338_original.png")); ?> loading="lazy" />-->
						<!--			</div>-->
						<!--		</a>-->
						<!--	</div>-->
						<!--</li>-->
						<li style="width:25%">
							<div class="client_wrapper">
								<a target="_blank" href="#" title="C4">
									<div class="gs-wrapper"><img width="250" height="40" src=<?php echo e(url("img/autoplaiwhite.png")); ?>
						...
						<li style="width:25%">
							<div class="client_wrapper">
								<a target="_blank" href="#" title="C4">
									<div class="gs-wrapper"><img width="150" height="40" src=<?php echo e(url("img/max-allo.png")); ?>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<div class="wp-block-column" style="flex-basis:33.33%">
						<figure class="wp-block-image size-full"><img loading="lazy" width="300" style="height:auto;"
								src="<?php echo e(url("img/maxlogo1.png")); ?>" class="wp-image-11" /> </figure>
					</div>
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-3">
					...
					<div style="height:25px" aria-hidden="true" class="wp-block-spacer"></div>
					<figure class="wp-block-image size-full"><img loading="lazy" width="249" height="20" src="<?php echo e(url("
					...
					<figure class="wp-block-image size-full"><img loading="lazy" width="223" height="21"
							src=<?php echo e(url("img/landing4-footer-pic2.webp")); ?> class="wp-image-13" /> </figure>
				</div>
				<div class="col-12">
	...
	<script src=<?php echo e(url("js/jquery-migrate-3.4.0.min.js")); ?>></script>
	<script src=<?php echo e(url("js/mfn.menu.js")); ?>></script>
	<script src=<?php echo e(url("js/jquery.plugins.js")); ?>></script>
	<script src=<?php echo e(url("js/jquery.jplayer.min.js")); ?>></script>
	<script src=<?php echo e(url("js/animations.js")); ?>></script>
	<script src=<?php echo e(url("js/translate3d.js")); ?>></script>
	<script src=<?php echo e(url("js/scripts.js")); ?>></script>
	<script src=<?php echo e(url("js/revolution.tools.min.js")); ?>></script>
	<script src=<?php echo e(url("js/rs6.min.js")); ?>></script>
	<script src=<?php echo e(url("phpmailer/form.js")); ?>></script>
	<script>
		var revapi1, tpj;
...
</html><?php /**PATH /home/maxallowance/public_html/homeb.maxallowance.com/resources/views/home.blade.php ENDPATH**/ ?>